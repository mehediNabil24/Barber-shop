...
const HairSalonsAroundYou: React.FC = () => {
  return (
    <div className="flex flex-col gap-4 px-[10px] xl:px-[200px] lg:px-[40px] mx-auto">
      <h2 className="lg:text-2xl text-[24px]  font-bold text-gray-800">Hair Salons - Around you</h2>
